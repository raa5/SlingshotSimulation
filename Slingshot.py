...
def main():
    ...
    objects = []
    trails = []  # List to hold trails of all objects
    temp_obj_pos = None
    ...
    while running:
        ...
        for obj in objects[:]:
            ...
            if off_screen or collided:
                trails.append(obj.trail)  # Save the trail before removing the object
                objects.remove(obj)
        ...
        # Display information for the first spacecraft in the list, if it exists
        if objects:
